    ...
    <div className="min-h-screen bg-[#fcfdfd] text-slate-900 antialiased">
      ...
      <section className="relative w-full overflow-hidden bg-slate-950 pt-32 sm:pt-40 pb-16 sm:pb-24">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute -top-24 right-1/4 w-96 h-96 bg-[radial-gradient(circle,_rgba(0,163,224,0.18)_0%,_transparent_70%)] pointer-events-none" />
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <section className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/90 shadow-xs space-y-6">
              <div className="flex items-center gap-4">
                <div className="size-11 rounded-2xl bg-sky-50 text-[#01214A] flex items-center justify-center shrink-0">
            ...
            {job.salaryRange && (
              <section className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/90 shadow-xs space-y-6">
                ...
                <div className="p-6 rounded-2xl bg-sky-50/70 border border-sky-200/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
                  <div>
                    <span className="text-[11px] font-extrabold uppercase tracking-wider text-[#01214A] block">
          ...
          <div className="lg:col-span-5" id="apply-now">
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/90 shadow-md sticky top-28 space-y-6">
              ...
              <div className="space-y-1.5 pb-2 border-b border-slate-100">
                <span className="inline-block text-[10px] font-extrabold uppercase tracking-wider text-[#01214A] bg-sky-50 border border-sky-200 px-2.5 py-1 rounded-md">
              ...
              <div className="p-4 rounded-2xl bg-[#fafbfc] border border-slate-200/70 space-y-2.5 text-xs">
                ...
                {job.deadline && (
                  <div className="flex justify-between items-center text-slate-600 border-t border-slate-200/70 pt-2">
                    ...
                    <span className="font-bold text-[#01214A]">{job.deadline}</span>
                  </div>
                )}
              </div>
        ...
        {job.benefits && job.benefits.length > 0 && (
          <section className="mt-12 bg-gradient-to-br from-[#01214A] via-[#023168] to-[#011632] text-white rounded-3xl p-10 sm:p-14 shadow-md space-y-8 relative overflow-hidden">
            {/* Ambient glows */}
            <div className="absolute top-0 right-0 w-[28rem] h-[28rem] bg-[radial-gradient(circle,_rgba(0,163,224,0.15)_0%,_transparent_70%)] pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-[radial-gradient(circle,_rgba(0,163,224,0.08)_0%,_transparent_70%)] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-sky-100/80 leading-relaxed max-w-xl">
              ...
              {otherJobs.map((oj) => (
                ...
                >
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                    <Link
                      href={`/jobs/${oj.id}`}
                      className="text-xs font-bold text-[#01214A] hover:underline"
                    >
                      View Job Details
                    </Link>
                    <JobApplicationDialog
